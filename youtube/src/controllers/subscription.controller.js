...
const toggleSubscription = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if(!user){
            ...
            const deleteSubscription = await Subscription.findByIdAndDelete(user?._id)
...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,userChannelSubscribers,"Subscriber list fetched"))
...
const getSubscribedChannels = asyncHandler(async (req, res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,subscribedChannel,"Subscribed channels fetched"))
})
